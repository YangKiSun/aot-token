...
이런 O2O시장은 처음에는 쇼셜네트워크서비스를 이용하여 여러명이 모여 싼 가격에 제품을 사는 제도인 소셜커머스에서 부터이다.(소셜커머스는 일정한 기간 동안에 어떠한 제품을 할인한다고 홍보하면 사람들이 구매 의사를 표시하고, 공급자가 그에 맞추어 제품을 보내주는 구매 제도) 스타벅스의 예시처럼 O2O 방식은 이미 우리 생활에 깊게 자리 잡았다.&#x20;
